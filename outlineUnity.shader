            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                // If outline is enabled and there is a pixel, try to draw an outline.
                    ...
                    for (int i = 1; i < _OutlineSize + 1; i++) {
                        ...
                        if(pixelUp.a + pixelDown.a + pixelRight.a + pixelLeft.a > 0) { distance = i; break; }
                    }

                    if (distance > 0) {
                        float totalAlpha = 1 - ((distance * 1.0f)/_OutlineSize);
                        c.rgba = fixed4(1, 1, 1, totalAlpha) * _OutlineColor;
                    }
                }
